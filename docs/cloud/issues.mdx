...
The fastest way to create an issue:

1. Click the **+** button at the top of any status column
2. Type the issue title
3. Press **Enter** to create


The issue is created in that column with default settings. You can click it to add more details.

### Create with Details

To create an issue with full details:

<Steps>
<Step title="Open the create panel">
  Click the **+ New Issue** button in the header, or use the keyboard shortcut.
...
<Step title="Create the issue">
  Click **Create** to save the issue, or **Create & Open** to create it and immediately open the full panel.
</Step>
</Steps>
...
1. When creating an issue, enable **Create draft workspace**
