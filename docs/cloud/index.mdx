...
3. **Create an organisation** to group your team
4. **Invite team members** via email
5. **Collaborate** on projects with real-time sync
...
<Step title="Sign in">
  Click **Login** and sign in with GitHub or Google.
</Step>

<Step title="Create organisation">
  Enter your team or company name.
</Step>
...
<Step title="Invite team (optional)">
  Go to organisation settings and invite members by email.
</Step>
</Steps>
