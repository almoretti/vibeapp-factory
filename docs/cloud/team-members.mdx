...
<Step title="Go to Organisation Settings">
  Click the gear icon (<Icon icon="gear" />) next to your organisation name, or go to **Settings** → **Members**.
...
To see invitations that haven't been accepted yet:
...
All current members are listed in **Settings** → **Members**:


Each member shows:
- **Name** - Their display name from GitHub/Google
...
<Step title="Find the member">
  Go to **Settings** → **Members** and locate the person.
</Step>

<Step title="Click the role dropdown">
  Click on their current role to open the dropdown.
...
<Step title="Click Remove">
  Click the **Remove** button (or trash icon) next to their name.
...
3. Try resending the invitation from the Pending tab
